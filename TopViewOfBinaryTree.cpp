...
Intuition: Similar to Vertical Order Traversal of Binary Tree. 
We will use a one-to-one mapping of the horizontal distance and the first occurrence of the value at that distance on the number line. 
As all the remaining nodes will be hidden.
